...
Hệ thống đặt lịch và quản lý dịch vụ **hoán đổi pin xe điện** (Electric Vehicle Battery Swap).  
<p align="center">
  <img src="https://raw.githubusercontent.com/0xA34/EVBatterySwap/refs/heads/main/src/main/resources/static/assets/logo.png" alt="Logo">
</p>
...
-  **Tìm kiếm trạm theo địa chỉ phân cấp**: Tỉnh/Thành → Quận/Huyện → Phường/Xã
